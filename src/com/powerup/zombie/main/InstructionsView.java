...
public class InstructionsView extends Activity {
	...
	private int[] instructionsImages = new int[]{R.drawable.manual1, R.drawable.manual2};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(15000, 7000) {
        	LinearLayout layout = (LinearLayout)findViewById(R.id.instructions);
        	int i = 0;
			
			@Override
			public void onTick(long millisUntilFinished) {
				layout.setBackgroundResource(instructionsImages[i]);
				i++;
			}
