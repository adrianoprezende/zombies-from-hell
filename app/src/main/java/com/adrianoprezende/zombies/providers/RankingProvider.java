package com.adrianoprezende.zombies.providers;
...
import com.adrianoprezende.zombies.providers.helpers.DBHelper;
...
public class RankingProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.adrianoprezende.zombies";
	...
	//public static final Uri CONTENT_URI = Uri.parse("content://com.adrianoprezende.zombies");
